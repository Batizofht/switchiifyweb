    ...
    <div className="min-h-screen flex pt-14">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 p-16">
          ...
          <h2 className="text-3xl font-bold text-white leading-tight mb-4 max-w-sm">
            Join the future of technology.
          </h2>
          <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
            Get access to Gamingar, Neuro AI, OpenSpace, and everything Switchiify builds — free to start.
          </p>
        </div>
      </div>

      {/* Right — form */}
      <div className="flex-1 flex items-center justify-center px-3 sm:px-6 bg-black overflow-y-auto py-8">
        <motion.div
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-zinc-400 text-sm">Start building with Switchiify for free</p>
          </div>
          ...
          >
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" placeholder="Jean" className={inputClass} />
              </div>
              <div>
                <label className="block text-xs text-zinc-400 mb-1.5">Last name</label>
                <input type="text" placeholder="Baptiste" className={inputClass} />
              </div>
            </div>
            <div>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <div
                ...
                className={`w-4 h-4 rounded border flex items-center justify-center shrink-0 mt-0.5 transition-colors ${
                  agreed ? 'bg-white border-white' : 'border-zinc-700 hover:border-zinc-500'
                }`}
              >
                {agreed && (
              ...
              <span className="text-xs text-zinc-400 leading-relaxed">
                ...
                {' '}and{' '}
                <Link href="/legal" className="text-white hover:text-zinc-300 transition-colors">Privacy Policy</Link>
              </span>
            </label>
